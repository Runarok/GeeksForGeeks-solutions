<h2><a href="https://www.geeksforgeeks.org/problems/riyas-test1450/1?page=2&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Same frequency in two halves</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string S, find whether it fulfills the following criteria.&nbsp;<br>
