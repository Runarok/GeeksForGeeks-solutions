<h2><a href="https://www.geeksforgeeks.org/problems/cube-root-of-a-number0915/1?page=5&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Cube root of a number</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given a number <strong>n</strong>, find the cube root of<strong> n</strong>.</span></p>
