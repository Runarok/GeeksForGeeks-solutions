<h2><a href="https://www.geeksforgeeks.org/problems/swap-kth-elements5500/1?page=4&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Swap kth elements</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong>, swap the <strong>k<sup>th</sup></strong> element from the beginning with the <strong>k<sup>th</sup></strong> element from the end.</span></p>
