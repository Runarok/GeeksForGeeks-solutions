<h2><a href="https://www.geeksforgeeks.org/problems/12-hour-clock-subtraction1708/1?page=2&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">12 hour clock subtraction</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two positive integers&nbsp;<strong>num1&nbsp;</strong>and&nbsp;<strong>num2</strong>, subtract num2 from num1 on a&nbsp;<strong><u><em>12 hour clock</em></u></strong> rather than a number line.</span><br>
