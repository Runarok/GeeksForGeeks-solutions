<h2><a href="https://www.geeksforgeeks.org/problems/find-the-maximum-number-of-handshakes2349/1?page=9&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Maximum Handshakes</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">There are&nbsp;<strong>N</strong>&nbsp;people in a room. If two persons shake hands exactly once,&nbsp;find the maximum number of handshakes possible.&nbsp;</span></p>
