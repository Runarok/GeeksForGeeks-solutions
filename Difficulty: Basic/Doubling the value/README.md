<h2><a href="https://www.geeksforgeeks.org/problems/doubling-the-value4859/1?page=1&company=Flipkart&difficulty=Basic,Easy&status=unsolved&sortBy=submissions">Doubling the value</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array and an integer B, traverse the array (from the beginning) and if the element in array is B, double B&nbsp;and continue traversal. Find the value of B after the complete traversal.</span></p>
