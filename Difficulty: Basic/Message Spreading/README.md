<h2><a href="https://www.geeksforgeeks.org/problems/message-spreading4258/1?page=1&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Message Spreading</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">There are N students in a class, each in possession of a different funny story.&nbsp;</span></p>
