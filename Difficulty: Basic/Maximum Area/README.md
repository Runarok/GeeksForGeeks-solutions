<h2><a href="https://www.geeksforgeeks.org/problems/maximum-area2642/1?page=3&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Maximum Area</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given the maximum possible&nbsp;area of the right angle triangle for a fixed length of hypotenuse. The task is to find the length of hypotenuse.</span></p>
