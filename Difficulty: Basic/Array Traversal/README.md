<h2><a href="https://www.geeksforgeeks.org/problems/array-traversal/1?page=3&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Array Traversal</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given an array <strong>arr[]</strong> that contains integers. You need to print the elements of the array in a <strong>single line</strong> with a <strong>space</strong> between them.<br>Note: Don't add a new line at the end.</span></p>
