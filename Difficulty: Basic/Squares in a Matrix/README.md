<h2><a href="https://www.geeksforgeeks.org/problems/squares-in-a-matrix5716/1?page=1&category=Matrix&status=unsolved,attempted&sortBy=accuracy">Squares in a Matrix</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a <strong>mxn</strong> matrix, count the number of squares in the matrix. </span></p>
