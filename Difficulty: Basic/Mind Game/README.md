<h2><a href="https://www.geeksforgeeks.org/problems/mind-game3637/1?page=1&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Mind Game</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Someone is asked to perform the following operations on a randomly chosen number between 1 and 10.</span></p>
