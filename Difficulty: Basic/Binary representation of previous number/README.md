<h2><a href="https://www.geeksforgeeks.org/problems/binary-representation-of-previous-number0638/1?page=30&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Binary representation of previous number</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a binary representation in the form of string(S) of a number n, the task is to find a binary representation of n-1.</span></p>
