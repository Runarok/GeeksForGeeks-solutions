<h2><a href="https://www.geeksforgeeks.org/problems/check-if-the-number-is-fibonacci4654/1?page=1&company=Adobe&difficulty=Basic,Easy,Medium&status=unsolved&sortBy=accuracy">Check if the number is Fibonacci</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Check if a given number N is the Fibonacci number. A Fibonacci number is a number that occurs in the Fibonacci series.</span></p>
