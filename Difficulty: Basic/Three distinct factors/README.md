<h2><a href="https://www.geeksforgeeks.org/problems/three-distinct-factors5613/1?page=29&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Three distinct factors</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive integer <strong>N</strong>. The task is to check whether a number has exactly three distinct factors or not. </span></p>
...
</div><p><span style=font-size:18px><strong>Company Tags : </strong><br><code>VMWare</code>&nbsp;<br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Mathematical</code>&nbsp;<code>Prime Number</code>&nbsp;<code>Numbers</code>&nbsp;<code>Algorithms</code>&nbsp;