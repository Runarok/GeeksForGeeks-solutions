<h2><a href="https://www.geeksforgeeks.org/problems/sum-the-common-elements/1?page=12&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Sum the common elements</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><div class="problemQuestion">
