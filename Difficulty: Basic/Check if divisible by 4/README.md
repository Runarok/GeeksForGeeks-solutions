<h2><a href="https://www.geeksforgeeks.org/problems/check-if-divisible-by-43813/1?page=3&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Check if divisible by 4</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a number <strong>N</strong>. Check whether it is divisble by 4.</span></p>
