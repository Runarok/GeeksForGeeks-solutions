<h2><a href="https://www.geeksforgeeks.org/problems/pattern-13116/1?page=1&difficulty=Basic&status=unsolved,attempted&sortBy=accuracy">Pattern-1</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N</strong>, identify the pattern from&nbsp; the given Examples and print the Output.</span></p>
