<h2><a href="https://www.geeksforgeeks.org/problems/number-game0303/1?page=2&status=unsolved&sortBy=accuracy">Number Game</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a number <strong>n</strong> the task is to find the minimum number which is divisible by all numbers from 1 to n. </span><span style="font-size: 18px;">Print the answer modulo (10<sup>9</sup>+7).</span></p>
<p>&nbsp;</p>
