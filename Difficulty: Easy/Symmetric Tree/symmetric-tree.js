...
class Solution {
    ...
    isSymmetric(root) {
        // A helper function to check if two trees are mirror images of each other
        ...
        // Start the recursion from the root and its mirror image
