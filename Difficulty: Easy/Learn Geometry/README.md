<h2><a href="https://www.geeksforgeeks.org/problems/learn-geometry5429/1?page=6&status=unsolved&sortBy=accuracy">Learn Geometry</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Find max number of squares (<strong>S</strong>) of side 2 units that can fit in an Isosceles triangle with a right angle and its shortest side equal to <strong>"B"</strong> units.</span><br>
