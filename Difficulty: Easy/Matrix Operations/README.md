<h2><a href="https://www.geeksforgeeks.org/problems/matrix-operations/1?page=1&company=Flipkart,Adobe,Samsung&difficulty=Easy,Medium,Hard&status=unsolved,attempted&sortBy=accuracy">Matrix Operations</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a binary matrix&nbsp;of dimensions <strong>M&nbsp;* N.&nbsp;</strong>One can perform the given operation in&nbsp;the matrix.</span></p>
