<h2><a href="https://www.geeksforgeeks.org/problems/magic-in-c--141631/1?page=2&difficulty=Easy&status=unsolved,attempted&sortBy=accuracy">Magic in C</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><em><span style="font-size:18px">This Module is all about pointers and how they can be cleverly employed to solve typical C&nbsp;problems.</span></em></p>
...
Your task is to complete the&nbsp;<strong>swap()</strong> function, such that values of <strong>A and B gets</strong> interchanged.</span></p>
