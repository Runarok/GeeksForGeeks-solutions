<h2><a href="https://www.geeksforgeeks.org/problems/odd-game5040/1?page=3&status=unsolved&sortBy=accuracy">Odd Game</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array of length <strong>N</strong>, starting from 1 to N. At each iteration, you remove all elements at odd positions, until only one element is left. Find the last remaining element.</span></p>
