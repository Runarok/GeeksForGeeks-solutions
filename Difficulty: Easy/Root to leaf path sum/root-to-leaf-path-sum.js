 ...
 */
class Solution {
    // Function to check if there is a path from root to leaf with the sum equal to target
    hasPathSum(root, target) {
        ...
        // If the current node is a leaf, check if target is 0
