<h2><a href="https://www.geeksforgeeks.org/problems/reverse-bits3556/1?page=1&company=Amazon&status=unsolved,attempted&sortBy=accuracy">Reverse Bits</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a <strong>number x</strong>, <strong>reverse </strong>its binary form and return the answer in <strong>decimal</strong>.</span></p>
