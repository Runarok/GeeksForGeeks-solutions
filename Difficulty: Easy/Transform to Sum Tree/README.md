<h2><a href="https://www.geeksforgeeks.org/problems/transform-to-sum-tree/1?page=1&company=Samsung&difficulty=Easy,Medium,Hard&status=unsolved,attempted&sortBy=accuracy">Transform to Sum Tree</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Binary Tree of size N , where each node can have positive or negative values. Convert this to a tree where each node contains the sum of the left and right sub trees of the original tree. The values of leaf nodes are changed to 0.</span></p>
