<h2><a href="https://www.geeksforgeeks.org/problems/linear-diophantine-equations5649/1?page=3&status=unsolved&sortBy=accuracy">Linear Diophantine Equations</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">A Diophantine equation is a polynomial equation, usually in two or more unknowns, such that only the integral solutions are required. An Integral solution is a solution such that all the unknown variables take only integer values.</span></p>
