<h2><a href="https://www.geeksforgeeks.org/problems/k-distance-from-root/1?page=1&company=Samsung&difficulty=Easy,Medium&status=unsolved&sortBy=accuracy">K distance from root</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a binary tree having <strong>n</strong> nodes and an integer <strong>k</strong>. Print all nodes that are at distance k from the root (root is considered at distance 0 from itself). Nodes should be printed from <strong>left to right</strong>.</span></p>
