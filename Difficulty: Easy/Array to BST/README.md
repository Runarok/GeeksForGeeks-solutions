<h2><a href="https://www.geeksforgeeks.org/problems/array-to-bst4443/1?page=3&difficulty=Easy&status=solved,unsolved,attempted&sprint=a663236c31453b969852f9ea22507634&sortBy=difficulty">Array to BST</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a <strong>sorted </strong>array. Convert it into a <strong>Height Balanced</strong> Binary Search Tree (BST). Return the <strong>root </strong>of the BST.</span></p>
<blockquote>
