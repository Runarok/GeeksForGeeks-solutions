<h2><a href="https://www.geeksforgeeks.org/problems/common-subsequence4049/1?page=1&company=Amazon&status=unsolved,attempted&sortBy=accuracy">Common Subsequence</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given two strings<strong> a</strong> and<strong> b.</strong> Check&nbsp;whether they contain any common subsequence (non empty)&nbsp;or not.</span></p>
