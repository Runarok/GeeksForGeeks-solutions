<h2><a href="https://www.geeksforgeeks.org/problems/consecutive-numbers-for-sum3132/1?page=2&status=unsolved&sortBy=accuracy">Consecutive numbers for sum</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N</strong>, find whether N can be expressed as sum of two or more consecutive positive numbers. </span></p>
