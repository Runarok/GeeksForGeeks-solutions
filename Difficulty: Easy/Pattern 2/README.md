<h2><a href="https://www.geeksforgeeks.org/problems/right-triangle/1?page=1&status=unsolved&sortBy=accuracy">Pattern 2</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Geek is very fond of patterns. Once, his teacher gave him a pattern of triangle to solve. He gave Geek an integer n and asked him to build a pattern.</span></p>
