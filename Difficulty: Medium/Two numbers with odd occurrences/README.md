<h2><a href="https://www.geeksforgeeks.org/problems/two-numbers-with-odd-occurrences5846/1?page=2&difficulty=Medium&status=unsolved,attempted&sortBy=accuracy">Two numbers with odd occurrences</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an unsorted array,&nbsp;<strong>Arr</strong>[] of size <strong>N</strong> and that contains <strong>even </strong>number of occurrences for all numbers except two numbers. Find the two numbers in <strong>decreasing</strong> order which has <strong>odd</strong> occurrences.</span><br><br><span style="font-size: 18px;"><strong>Example 1:</strong></span></p>
