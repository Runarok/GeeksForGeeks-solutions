<h2><a href="https://www.geeksforgeeks.org/problems/card-rotation5834/1?page=1&difficulty=Medium&status=unsolved,attempted&sortBy=accuracy">Card Rotation</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a sorted deck of cards numbered 1 to N.</span></p>
