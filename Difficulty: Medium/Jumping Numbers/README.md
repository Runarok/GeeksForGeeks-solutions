<h2><a href="https://www.geeksforgeeks.org/problems/jumping-numbers3805/1?page=17&difficulty=Medium&status=unsolved,attempted&sortBy=accuracy">Jumping Numbers</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive number <strong>X</strong>. Find the largest Jumping Number which is smaller than or equal to X.&nbsp;<br>
