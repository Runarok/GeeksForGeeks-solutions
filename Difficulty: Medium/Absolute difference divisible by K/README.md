<h2><a href="https://www.geeksforgeeks.org/problems/absolute-difference-divisible-by-k/1?page=2&difficulty=Medium&status=unsolved,attempted&sortBy=accuracy">Absolute difference divisible by K</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array of integers&nbsp;of size <strong>n</strong> and an integer&nbsp;<strong>k</strong>, find all the pairs in the array&nbsp;whose absolute difference is divisible by k.</span><br><br><span style="font-size: 18px;"><strong>Example 1:</strong></span></p>
